-- Buckets de Storage para las fotos de empleados y de artículos.
...
values ('empleados', 'empleados', true), ('productos', 'productos', true)
...
create policy storage_subir on storage.objects for insert to authenticated
  with check (bucket_id in ('empleados', 'productos'));
